//Example from https://github.com/spray/spray/blob/master/examples/spray-can/simple-http-client/src/main/scala/spray/examples/Main.scala
...
object ServerVersionDemoMain extends App
